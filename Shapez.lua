...
local captcha = ''
local captchaTable = {}
local arizonaServers = {'185.169.134.3', '185.169.134.4', '185.169.134.43', '185.169.134.44', '185.169.134.45', '185.169.134.5', '185.169.134.59', '185.169.134.61', '185.169.134.107', '185.169.134.109', '185.169.134.166', '185.169.134.171', '185.169.134.172', '185.169.134.173', '185.169.134.174', '80.66.82.191', '80.66.82.190', '80.66.82.188', '80.66.82.168', '80.66.82.159', '80.66.82.200', '80.66.82.144'}
local t = 0
...
-- https://github.com/Faded01/Shapez
...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/Faded01/Shapez/main/update.json?" .. tostring(os.clock())
            Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
            Update.url = "https://github.com/Faded01/Shapez"
        end
    end
end
